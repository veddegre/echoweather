...
function sunPosition(date, lat, lon){
  ...
  const d = toD(date);
  const M = RAD * (357.5294 + 0.98560028 * d);
...
const NWS_DIR = {N:0,NE:45,E:90,SE:135,S:180,SW:225,W:270,NW:315,NNE:22.5,ENE:67.5,ESE:112.5,SSE:157.5,SSW:202.5,WSW:247.5,WNW:294.5,NNW:337.5};
...
function moonCoords(d){
  const L = RAD * (218.316 + 13.176396 * d),
        ...
        F = RAD * (93.272 + 13.229450 * d);
  const l = L + RAD * 6.294 * Math.sin(M),
